...
Use public references as directional inputs, then adapt into original BankerDeck themes:
...
Default banking deliverable style.

- Palette: navy `#17365D`, slate `#5B6770`, blue `#4472C4`, light gray `#F3F5F7`, accent green `#70AD47`.
- Typography: Aptos/Arial fallback; compact hierarchy.
- Best for: pitch books, valuation, transaction, market scan, investor materials.
- Style: dense but clean, strong title rule, small source footer.
...
China investment research and advisory style.
...
High-contrast boutique advisory style.

- Palette: charcoal `#111827`, white `#FFFFFF`, cyan `#22D3EE`, violet `#7C3AED`, gray `#374151`.
- Typography: modern, lighter density.
- Best for: tech, growth equity, founder/investor narratives.
- Style: dark section dividers, bright callouts, minimal tables.

### board-clean

Board and management discussion style.

- Palette: black `#111111`, gray `#6B7280`, blue `#2563EB`, light gray `#F8FAFC`, red `#B91C1C`.
